...
export const BADGE_DEFS: BadgeDef[] = [
  ...
  { id: 'reviewerWeek', name: 'Top Reviewer',  icon: '👁️', rarity: 'rare',      desc: 'most reviews this month'          },
  ...
  { id: 'ghostSlayer',  name: 'Ghost Slayer',  icon: '⚔️', rarity: 'legendary', desc: '10+ issues in a month'            },
